...
- [ ] **T31** — **Milestone check:** one clean sample bill (e.g. Summit Pharma CSV) goes in, resolves automatically, writes to `purchase_ledger`, with no anomalies. This is Demo Bill 1 — get it working before anything else.
